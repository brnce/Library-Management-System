...
public class LibraryServiceImpl implements LibraryService {
	...
	//getting the list of books for the employee to pick to borrow
		...
		//positive copies to be inputed if using my (Nats) impl, negative copies if using Roxanas impl 
		@Override
		public Library borrowBook(int bookId, int copies, Employee employee) {
		...
		//negative number of copies inputed here (whatever the number want to return - do the negative of that)
		//NEED TO ADD NUMBER OF COPIES IN LIBRARY - CHECK FOR IF THE COPIES IS 0 THEN DELETE THAT ENTRY INSIDE OF LIBRARY 
		@Override
		public Library returnBook(String transactionId, int copies) {
