...
-- can use sarah for book cap demo 
-- have matched book quantities to library entries
insert into employee
values(1, "Bob", "password1", 1),
(2, "Martin", "password2", 1),
(3, "Sarah", "password3", 5);
...
-- inserting values : book 117 for no copy error, book 888 has 2 copies
insert into book
...
(444, "Big Data: A Revolution That Will Transform How We Live, Work, and Think", "Data Analytics", "Viktor Mayer-Schönberger", "A revelatory exploration of the hottest trend in technology and the dramatic impact it will have on the economy, science, and society at large.", 38),
